      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="flex gap-2">
              {(['Classification', 'Regression'] as TaskType[]).map(t => (
                <button
                  ...
                  className={`flex-1 py-1.5 text-[10px] font-bold uppercase border ${stats.taskType === t ? 'border-amber-500 text-amber-500 bg-amber-500/10' : 'border-[#333] text-zinc-500'}`}
                >
                  {t}
                </button>
              ))}
        ...
        <section>
          <button 
            ...
            className="flex items-center justify-between w-full text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4 hover:text-zinc-300"
          >
            ...
            <div className="space-y-4 pt-2 border-t border-[#222]">
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  defaultValue={stats.trainLoss?.join(', ')}
